...
does not exceed 2.3, and the 95th percentile ratio does exceed 1.6. \hanna{is does exceed right?}Thus the
...
\input{br-synthetic-plots} \hanna{fix}

\subsection{Real-World Performance (InnoDB)}\label{sec:br-exp-innodb}

In this section, we empirically \hanna{evaluate?} the performance of insertion buffers in
